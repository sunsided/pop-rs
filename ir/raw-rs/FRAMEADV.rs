...
impl Cpu {
        ...
        loop {
            match pc {
                0 => {
                    ...
                    self.setback();
                    self.getprev();
                    self.set_a(self.mem[sym::SCRNUM]);
                    self.calcblue();
                    self.set_y(0x02);
                    pc = 1;
                }
                1 => {
                    ...
                    self.set_a(self.mem[(sym::BlockBot + 1 + self.reg.y as usize) & 0xffff]);
                    ...
                    self.set_a(self.mem[(sym::PREV + self.reg.y as usize) & 0xffff]);
                    self.mem[sym::PRECED] = self.reg.a;
                    self.set_a(self.mem[(sym::sprev + self.reg.y as usize) & 0xffff]);
                ...
                2 => {
                    ...
                    self.set_y(self.mem[sym::yindex]);
                    self.getobjid();
                ...
                5 => {
                    self.set_y(0x02);  // bottom row of scrn above
                    self.mem[sym::rowno] = self.reg.y;
                    self.set_a(0x02);
                    self.mem[sym::Dy] = self.reg.a;
                    self.set_a(0xff);
                    ...
                    self.set_a(self.mem[sym::scrnBelowL]);
                    self.stack.push(self.reg.a);
                    self.set_a(self.mem[sym::SCRNUM]);
                    self.mem[sym::scrnBelow] = self.reg.a;
                    self.set_a(self.mem[sym::scrnLeft]);
                ...
                7 => {
                    self.set_a(0x01);  // If screen above is null screen,
                    if self.reg.a != 0x00 {
                        pc = 9;
                    } else {
                        pc = 8;
    ...
    fn RedBlockFast(&mut self) {
        ...
        'b6: {
            self.set_a(self.mem[(sym::redbuf + self.reg.y as usize) & 0xffff]);
            if self.reg.a != 0x00 {
                self.flags.c = true;
                let _r = (self.reg.a as u16) + (!0x01_u8) as u16 + (self.flags.c as u16);
                self.flags.c = (_r >> 8) != 0;
            ...
            self.set_a(self.mem[(sym::movebuf + self.reg.y as usize) & 0xffff]);
            if self.reg.a != 0x00 {
                self.flags.c = true;
                let _r = (self.reg.a as u16) + (!0x01_u8) as u16 + (self.flags.c as u16);
                self.flags.c = (_r >> 8) != 0;
        ...
        'b10: {
            self.set_a(self.mem[(sym::floorbuf + self.reg.y as usize) & 0xffff]);
            if self.reg.a != 0x00 {
                self.flags.c = true;
                let _r = (self.reg.a as u16) + (!0x01_u8) as u16 + (self.flags.c as u16);
                self.flags.c = (_r >> 8) != 0;
            ...
            self.set_a(self.mem[(sym::halfbuf + self.reg.y as usize) & 0xffff]);
            if self.reg.a != 0x00 {
                self.flags.c = true;
                let _r = (self.reg.a as u16) + (!0x01_u8) as u16 + (self.flags.c as u16);
                self.flags.c = (_r >> 8) != 0;
        ...
        self.set_a(self.mem[(sym::objbuf + self.reg.y as usize) & 0xffff]);
        if self.reg.a != 0x00 {
            self.set_a(0x00);
        ...
        self.set_a(self.mem[(sym::fredbuf + self.reg.y as usize) & 0xffff]);
        if self.reg.a != 0x00 {
            self.flags.c = true;
            let _r = (self.reg.a as u16) + (!0x01_u8) as u16 + (self.flags.c as u16);
            self.flags.c = (_r >> 8) != 0;
    ...
    fn RedDFast(&mut self) {
        self.set_y(self.mem[sym::colno]);
        self.set_a(self.mem[(sym::topbuf + self.reg.y as usize) & 0xffff]);
        if self.reg.a != 0x00 {
            self.flags.c = true;
            let _r = (self.reg.a as u16) + (!0x01_u8) as u16 + (self.flags.c as u16);
            self.flags.c = (_r >> 8) != 0;
    ...
    fn drawobjs(&mut self) {
        ...
        loop {
            match pc {
                ...
                1 => {
                    self.set_y(0x00);  // y = sort list index
                    self.set_x(0x01);  // x = object list index
                    pc = 2;
                }
                2 => {
                    self.set_a(self.mem[(sym::objINDX + self.reg.x as usize) & 0xffff]);
    ...
    fn getbelow(&mut self) {
        ...
        loop {
            match pc {
                ...
                7 => {
                    self.set_a(self.mem[(sym::PREV + 1 + self.reg.x as usize) & 0xffff]);
                    self.mem[sym::BELOW] = self.reg.a;
                    self.set_a(self.mem[(sym::sprev + 1 + self.reg.x as usize) & 0xffff]);
                    self.mem[sym::SBELOW] = self.reg.a;
                    self.set_a(self.mem[sym::yindex]);
                    self.flags.c = false;
                ...
                17 => {
                    self.set_a(self.mem[(sym::objX + self.reg.x as usize) & 0xffff]);
                    self.mem[sym::FCharX] = self.reg.a;
                    self.mem[sym::XCO] = self.reg.a;
                    self.set_a(self.mem[(sym::objOFF + self.reg.x as usize) & 0xffff]);
                    self.mem[sym::OFFSET] = self.reg.a;
                    self.set_a(self.mem[(sym::objY + self.reg.x as usize) & 0xffff]);
                    self.mem[sym::FCharY] = self.reg.a;
                    self.mem[sym::YCO] = self.reg.a;
                    self.set_a(self.mem[(sym::objIMG + self.reg.x as usize) & 0xffff]);
                    self.mem[sym::IMAGE] = self.reg.a;
                    self.set_a(self.mem[(sym::objTAB + self.reg.x as usize) & 0xffff]);
                    self.mem[sym::TABLE] = self.reg.a;
                    self.set_a(self.mem[(sym::objFACE + self.reg.x as usize) & 0xffff]);
                    self.mem[sym::FCharFace] = self.reg.a;
                    self.set_a(self.mem[(sym::objCU + self.reg.x as usize) & 0xffff]);
                    self.mem[sym::FCharCU] = self.reg.a;
                    self.set_a(self.mem[(sym::objCD + self.reg.x as usize) & 0xffff]);
                    self.mem[sym::FCharCD] = self.reg.a;
                    self.set_a(self.mem[(sym::objCL + self.reg.x as usize) & 0xffff]);
                    self.mem[sym::FCharCL] = self.reg.a;
                    self.set_a(self.mem[(sym::objCR + self.reg.x as usize) & 0xffff]);
                    self.mem[sym::FCharCR] = self.reg.a;
                    self.set_a(self.mem[(sym::objTYP + self.reg.x as usize) & 0xffff]);
                    pc = 18;
                }
                18 => {
                    return;
    ...
    fn drawfrnt(&mut self) {
        self.set_x(self.mem[sym::PRECED]);
        if self.reg.x == 0x04 {
            self.DrawGateBF_3f();
        }
        ...
        if self.reg.x != 0x12 {
            'b9: {
                ...
                self.set_x(self.mem[sym::objid]);
                self.set_a(self.mem[(sym::fronti + self.reg.x as usize) & 0xffff]);
                if self.reg.a == 0x00 {
                    return;
                }
            }
            'b18: {
                ...
                if self.reg.x < 0x1b {
                    ...
                    if self.reg.x == 0x14 {
                        self.set_y(self.mem[sym::state]);
                        if self.reg.y >= 0x02 {
                            self.set_y(0x00);
                        }
                        self.set_a(self.mem[(sym::blockfr + self.reg.y as usize) & 0xffff]);
                        self.mem[sym::IMAGE] = self.reg.a;
                    } else {
                        self.maddfore();
                        return;
    ...
    fn drawmb(&mut self) {
        self.set_a(self.mem[sym::PRECED]);
        if self.reg.a != 0x04 {
            if self.reg.a != 0x02 {
                if self.reg.a != 0x0b {
                    if self.reg.a != 0x13 {
    ...
    fn drawmc(&mut self) {
        ...
        match self.reg.a {
            0x00 | 0x0c => {
                self.set_x(self.mem[sym::colno]);
                self.set_a(self.mem[(sym::BELOW + self.reg.x as usize) & 0xffff]);
                if self.reg.a != 0x04 {
                    return;
                }
                self.drawgatec();
    ...
    fn dodrawc(&mut self) {
        ...
        if self.reg.x == 0x14 {
            self.set_x(self.mem[sym::colno]);
            self.set_a(self.mem[(sym::SBELOW + self.reg.x as usize) & 0xffff]);
            self.set_y(self.reg.a);
            let _o: u8 = 0x02;
            self.flags.c = self.reg.y >= _o;
            self.flags.z = self.reg.y == _o;
            ...
            self.set_a(self.mem[(sym::blockc + self.reg.y as usize) & 0xffff]);
            if self.reg.a == 0x00 {
                return;
            }
        } else {
            self.set_a(self.mem[(sym::piecec + self.reg.x as usize) & 0xffff]);
            if self.reg.a == 0x00 {
                return;
            }
            let _o: u8 = 0x9f;
            ...
            if self.reg.a == 0x9f {
                ...
                self.set_a(self.mem[(sym::panelc + self.reg.y as usize) & 0xffff]);
                if self.reg.a == 0x00 {
                    return;
                }
            }
    ...
    fn domaskb(&mut self) {
        self.set_x(self.mem[sym::PRECED]);
        self.set_a(self.mem[(sym::maskb + self.reg.x as usize) & 0xffff]);
        if self.reg.a == 0x00 {
            return;
        }
        self.mem[sym::IMAGE] = self.reg.a;
        ...
        'b25: {
            'b24: {
                ...
                if self.reg.x == 0x00 {
                    ...
                    self.set_a(self.mem[(sym::spaceb + self.reg.y as usize) & 0xffff]);
                    if self.reg.a == 0x00 {
                        return;
                    }
                    self.mem[sym::IMAGE] = self.reg.a;
                    self.set_a(self.mem[(sym::spaceby + self.reg.y as usize) & 0xffff]);
                } else {
                    'b16: {
                        let _o: u8 = 0x01;
                        self.flags.c = self.reg.x >= _o;
                        ...
                        if self.reg.x != 0x01 {
                            ...
                            if self.reg.x == 0x14 {
                                ...
                                if self.reg.a == 0x9e {
                                    ...
                                    self.set_x(self.mem[sym::PRECED]);
                                    self.set_a(self.mem[(sym::bstripe + self.reg.x as usize) & 0xffff]);
                                    if self.reg.a == 0x00 {
                                        return;
                                    }
                                    self.mem[sym::IMAGE] = self.reg.a;
                            ...
                            self.mem[sym::IMAGE] = self.reg.a;
                            self.set_a(self.mem[(sym::pieceby + self.reg.x as usize) & 0xffff]);
                            break 'b24;
                        }
                    }
                    self.set_y(self.mem[sym::spreced]);
                    ...
                    self.set_a(self.mem[(sym::floorb + self.reg.y as usize) & 0xffff]);
                    if self.reg.a == 0x00 {
                        return;
                    }
                    self.mem[sym::IMAGE] = self.reg.a;
                    self.set_a(self.mem[(sym::floorby + self.reg.y as usize) & 0xffff]);
                }
            }
            self.flags.c = false;
    ...
    fn drawd(&mut self) {
        ...
        if self.reg.x == 0x14 {
            ...
            self.set_a(self.mem[(sym::blockd + self.reg.y as usize) & 0xffff]);
            if self.reg.a == 0x00 {
                self.set_a(self.mem[sym::PRECED]);
                let _o: u8 = 0x1a;
                self.flags.c = self.reg.a >= _o;
                ...
                if self.reg.a == 0x1a {
                    ...
                    self.set_a(0xa1);  // arch ends to L of panel
                    self.adda1();
                    return;
                }
                let _o: u8 = 0x07;
            ...
            self.set_a(self.mem[(sym::pieced + self.reg.x as usize) & 0xffff]);
            if self.reg.a == 0x00 {
                return;
            }
        }
    ...
    fn addamask(&mut self) {
        self.set_x(self.mem[sym::objid]);
        self.set_a(self.mem[(sym::maska + self.reg.x as usize) & 0xffff]);
        if self.reg.a == 0x00 {
            return;
        }
        self.mem[sym::IMAGE] = self.reg.a;
    ...
    fn drawloosed(&mut self) {
        self.set_a(self.mem[sym::state]);
        self.getloosey();
        self.set_a(self.mem[(sym::loosed + self.reg.y as usize) & 0xffff]);
        if self.reg.a == 0x00 {
            return;
        }
        self.mem[sym::IMAGE] = self.reg.a;
    ...
    fn drawlooseb(&mut self) {
        self.set_a(self.mem[sym::spreced]);
        self.getloosey();
    ...
    fn getpiecea(&mut self) {
        if self.reg.x == 0x0b {
            self.set_a(self.mem[sym::state]);
            self.getloosey();
            self.set_a(self.mem[(sym::loosea + self.reg.y as usize) & 0xffff]);
            return;
        }
        self.set_a(self.mem[(sym::piecea + self.reg.x as usize) & 0xffff]);
        return;
    }

    fn drawspikea(&mut self) {
        self.set_x(self.mem[sym::state]);
        if (self.reg.x as i8) < 0 {
            self.set_x(0x05);  // hibit set --> spikes extended
        }
        self.set_a(self.mem[(sym::spikea + self.reg.x as usize) & 0xffff]);
        if self.reg.a == 0x00 {
            return;
        }
        self.mem[sym::IMAGE] = self.reg.a;
    ...
    fn drawspikeb(&mut self) {
        self.set_x(self.mem[sym::spreced]);
        if (self.reg.x as i8) < 0 {
            self.set_x(0x05);  // hibit set --> spikes extended
        }
        self.set_a(self.mem[(sym::spikeb + self.reg.x as usize) & 0xffff]);
        if self.reg.a == 0x00 {
            return;
        }
        self.mem[sym::IMAGE] = self.reg.a;
    ...
    fn drawslicera(&mut self) {
        ...
        self.set_x(self.reg.a);
        if self.reg.x >= 0x06 {
            self.set_x(0x06);  // fully retracted
        }
        'b6: {
            'b5: {
                self.set_a(self.mem[(sym::slicerseq + self.reg.x as usize) & 0xffff]);
                self.set_x(self.reg.a);
                self.set_x(self.reg.x.wrapping_sub(1));
                self.mem[sym::xsave] = self.reg.x;
                self.set_a(self.mem[sym::blockxco]);
                ...
                self.set_a(self.mem[sym::state]);
                if (self.reg.a as i8) < 0 {
                    self.set_a(self.mem[(sym::slicerbot2 + self.reg.x as usize) & 0xffff]);
                    if self.reg.a != 0x00 {
                        break 'b5;
                    }
                }
                self.set_a(self.mem[(sym::slicerbot + self.reg.x as usize) & 0xffff]);
                if self.reg.a == 0x00 {
                    break 'b6;
                }
            }
        ...
        self.set_a(self.mem[(sym::slicertop + self.reg.x as usize) & 0xffff]);
        if self.reg.a == 0x00 {
            return;
        }
        self.mem[sym::IMAGE] = self.reg.a;
    ...
    fn drawslicerf(&mut self) {
        ...
        self.mem[sym::XCO] = self.mem[sym::blockxco];
        self.mem[sym::YCO] = self.mem[sym::Ay];
        self.set_a(self.mem[(sym::slicerfrnt + self.reg.x as usize) & 0xffff]);
        if self.reg.a == 0x00 {
            return;
        }
        self.mem[sym::IMAGE] = self.reg.a;
        ...
        loop {
            match pc {
                0 => {
                    ...
                    self.set_a(0x01);
                    self.mem[sym::OPACITY] = self.reg.a;
                    self.set_a(self.mem[sym::gatebot]);
                    self.flags.c = true;
    ...
    fn drawgateb(&mut self) {
        ...
        loop {
            match pc {
                ...
                10 => {
                    self.set_y(self.reg.a);
                    self.set_a(self.mem[(sym::gate8b - 1 + self.reg.y as usize) & 0xffff]);
                    self.mem[sym::IMAGE] = self.reg.a;
                    self.addback();
                    pc = 11;
                }
    ...
    fn DrawFF(&mut self) {
        ...
        self.set_a(0x02);
        self.addmid();
        self.set_x(self.mem[sym::FCharImage]);
    ...
    fn getobjid(&mut self) {
        ...
        match self.reg.a {
            0x06 => {
                ...
                self.set_a(self.reg.a & 0x1f);
                if self.reg.a < 0x02 {
                    self.set_a(0x06);  // plate up
                    return;
                }
                self.set_a(0x05);  // plate depressed
                return;
            }
            0x0f => {
                self.set_a(self.mem[sym::state]);
                ...
                self.set_a(0x01);  // depressed upp looks just like floor
                return;
            }
            _ => {}
        }
    ...
    fn compare(&mut self) {
        ...
        self.set_x(self.mem[sym::obj1]);
        self.set_y(self.mem[sym::obj2]);
        self.set_a(self.mem[(sym::objTYP + self.reg.x as usize) & 0xffff]);
        if self.reg.a == 0x01 {
            return;
        }
    ...
    fn GETINITOBJ(&mut self) {
        ...
        self.set_a(self.mem[((self.mem[sym::BlueSpec] as usize | (self.mem[sym::BlueSpec + 1] as usize) << 8) + self.reg.y as usize) & 0xffff]);
        self.set_x(self.reg.a);
        self.set_a(self.mem[(sym::initsettings - 1 + self.reg.x as usize) & 0xffff]);
        return;
    }
    ...
    fn metbufs3(&mut self) {
        ...
        self.mbsub();
        self.set_y(self.reg.y.wrapping_add(1));
        self.set_a(self.reg.a | self.mem[(sym::redbuf + self.reg.y as usize) & 0xffff]);
        self.set_a(self.reg.a | self.mem[(sym::floorbuf + self.reg.y as usize) & 0xffff]);
        self.set_a(self.reg.a | self.mem[(sym::halfbuf + self.reg.y as usize) & 0xffff]);
        self.set_a(self.reg.a | self.mem[(sym::fredbuf + self.reg.y as usize) & 0xffff]);
        self.set_a(self.reg.a | self.mem[(sym::wipebuf + self.reg.y as usize) & 0xffff]);
        return;
    }
