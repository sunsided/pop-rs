...
// POP source segment `TOPCTRL` (51 routines),
        ...
        if cpu.reg.a >= 0x01 {
            ...
            'b40: {
                ...
                if cpu.reg.a < 0x0e {
                    ...
                    crate::specialk::KEEPTIME(cpu);
                }
            }
            crate::subs::SHOWTIME(cpu);
            cpu.set_a(cpu.mem[sym::level]);
            let _o: u8 = 0x0d;
            cpu.flags.c = cpu.reg.a >= _o;
            cpu.flags.z = cpu.reg.a == _o;
...
pub fn ResumeGame(cpu: &mut Cpu) {
    ...
    crate::grafix::LOADGAME(cpu);
    cpu.set_a(cpu.mem[sym::SavLevel]);
    if (cpu.reg.a as i8) >= 0 {
        cpu.mem[sym::origstrength] = cpu.mem[sym::SavStrength];
        cpu.mem[sym::FrameCount + 1] = cpu.mem[sym::SavTimer + 1];
        cpu.mem[sym::FrameCount] = cpu.mem[sym::SavTimer];
        cpu.mem[sym::NextTimeMsg] = cpu.mem[sym::SavNextMsg];
        cpu.mem[sym::timerequest] = 0x01;
        cpu.mem[sym::yellowflag] = 0x80;
        cpu.set_a(cpu.mem[sym::SavLevel]);
        cpu.mem[sym::level] = cpu.reg.a;
        cpu.mem[sym::NextLevel] = cpu.reg.a;
        RESTART(cpu);
...
pub fn songcues(cpu: &mut Cpu) {
    ...
    cpu.set_a(cpu.mem[sym::SongCount]);
    if cpu.reg.a != 0x00 {
        let _v = cpu.mem[sym::SongCount].wrapping_sub(1);
        cpu.mem[sym::SongCount] = _v;
        cpu.set_nz(_v);
        ...
        if cpu.reg.a != 0x00 {
            ...
            cpu.flags.n = (cpu.reg.a.wrapping_sub(_o) >> 7) != 0;
            if cpu.reg.a == 0x56 {
                cpu.set_a(cpu.mem[sym::trobcount]);
                if cpu.reg.a != 0x00 {
                    return;
                }
                cpu.set_a(cpu.mem[sym::nummob]);
                if cpu.reg.a != 0x00 {
                    return;
                }
                cpu.set_a(cpu.mem[sym::lightning]);
                ...
                if (cpu.reg.a as i8) < 0 {
                    ...
                    cpu.mem[sym::PAGE] = cpu.reg.a;
                    crate::specialk::LISTTORCHES(cpu);
                    cpu.set_a(cpu.mem[sym::SongCue]);
                    crate::grafix::MINIT(cpu);
                    cpu.mem[0xc010] = cpu.reg.a;
                    loop {
                        crate::specialk::BURN(cpu);
                ...
                cpu.set_a(cpu.mem[sym::ChgKidStr]);
                cpu.set_a(cpu.reg.a | cpu.mem[sym::ChgOppStr]);
                if cpu.reg.a != 0x00 {
                    return;
                }
                cpu.set_a(cpu.mem[sym::PAGE]);
            ...
            cpu.set_a(cpu.mem[sym::ShadPosn]);
            static_3f(cpu);
            if !cpu.flags.z {
                return;
            }
